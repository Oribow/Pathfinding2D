...
namespace Pathfinding2d.NavDataGeneration
{
    ...
    /// </summary>
    internal class MarkableContour : IEnumerable<PointNode>
    {
    ...
    /// </summary>
    internal class PointNode : IVisualizable
    {
    ...
    /// </summary>
    [Serializable]
    internal class SerializableMarkableContour
    {
    ...
    /// </summary>
    [Serializable]
    internal class SerializablePointNode
    {
        ...
        /// </summary>
        [Serializable]
        internal class SerializableObstructedSegment
        {
            public float start;
            public float end;
